                                         ...
                                         bool fUseTimeInterpolationAlways)
{
  if (fUseTimeInterpolationAlways)
    itsTime = theCalculationParams.itsTime;  // t‰m‰ on pakko tehd‰ kun k‰ytet‰‰n esim.
                                             // SumT-tyyppisi‰ SmartTool-funktioita ja niiden
...
{
  return itsJulianDay;  // t‰m‰ on jo laskettu Time-metodissa
}
                                   ...
                                   bool fUseTimeInterpolationAlways)
{
  if (fUseTimeInterpolationAlways)
    itsInfo->Time(
        theCalculationParams.itsTime);  // asetetaan ensin aika kohdalleen ja sitten kysyt‰‰n arvoa
  else
    itsInfo->TimeIndex(
        theCalculationParams
            .itsTimeIndex);  // asetetaan ensin aikaindeksi kohdalleen ja sitten kysyt‰‰n arvoa
...
double NFmiGridSizeAreaMask::Value(const NFmiCalculationParams& theCalculationParams,
                                   bool /* fUseTimeInterpolationAlways */)
{
  return CalcValueFromLocation(theCalculationParams.itsLatlon);  // ajalla ei ole v‰li‰
}
...
double NFmiGridSizeAreaMask::CalcValueFromLocation(const NFmiPoint& /* theLatLon */) const
{
  ...
  /*
          // T‰m‰ saattaisi olla maantieteellisesti oikea lasku tapa, mutta teen simppelin
     jakolaskun
